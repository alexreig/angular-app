...
import { MenusemanalComponent } from './menusemanal/menusemanal.component';
...
const routes: Routes = [
  ...
  { path: 'imagenes', component: ImagenesComponent, canActivate: [AuthGuard, RoleGuard], data: { role: 'ROLE_USER' } },
  ...
  { path: 'menusemanal', component: MenusemanalComponent, canActivate: [AuthGuard, RoleGuard], data: { role: 'ROLE_USER' } },
